package com.asd.template.shell;

import java.io.InputStream;
import java.io.OutputStream;

import com.asd.template.shell.sftp.monitor.MySftpProgressMonitor;
import com.asd.template.util.StringUtil;
...
public class Shell {
	 ...
	 * 
	 * @param input
	 *            连接的输入流，可以使用pipeInputStream,向输入流中写入数据
	 * @param output
	 *            连接的输出流，可以使用System.out打印在控制台
	 ...
	 *            源文件的（绝对）文件位置
	 * @param destDir
	 *            目标文件的文件路径 默认在/root/(root用户),／home/${user}/(普通用户)下
	 */
